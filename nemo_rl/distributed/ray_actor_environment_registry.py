...
ACTOR_ENVIRONMENT_REGISTRY: dict[str, str] = {
    ...
    # Atlas CudaGym env: a thin CudaGym HTTP client (no torch), runs in the system venv.
    "nemo_rl.environments.atlas.cudagym_environment.CudaGymEnvironment": PY_EXECUTABLES.SYSTEM,
